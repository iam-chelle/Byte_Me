...
--
-- Host: 127.0.0.1
-- Generation Time: May 06, 2021 at 11:38 AM
...
(7, '', 15, 11, 7, 3, 'P', 'P', 'X'),
(8, '', 6, 11, 3, 1, 'P', 'P', 'X'),
(13, '295466093b6eb0de02', 2, 12, 3, 4, 'C', 'C', 'I'),
(14, '460016093b71190afd', 11, 12, 5, 7, 'C', 'C', 'I'),
(16, '156656093b7d24f1d8', 37, 12, 5, 6, 'C', 'C', 'I'),
(17, '156656093b7d24f1d8', 37, 12, 5, 6, 'C', 'C', 'I'),
(18, '156656093b7d24f1d8', 11, 12, 5, 6, 'C', 'C', 'I');
...
CREATE TABLE `category` (
  ...
  `status` varchar(5) NOT NULL DEFAULT 'A' COMMENT 'A is for active and M for under maintenance'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, 'Foods', 'FR-F(1).jpg', 'A'),
(2, 'Beverages', 'FR-B(2).jpg', 'A'),
(3, 'Crafts', 'FR-C(3).jpg', 'A'),
(4, 'Accessories', 'FR-A(4).jpg', 'A'),
(5, 'Shirts', 'FR-S(5).jpg', 'A');
...
(6, 'Jef Ry', 22, 'M', 'Jovellar Albay Bicol', '09759213248', 'sguerajef7@gmail.com', 'A', NULL),
(7, 'Reymar Llagas', 20, 'M', 'napo', '123123', 'rallagas@bicol-u.edu.ph', 'A', NULL);
...
(1, 'Guinobatan Longanisa', 'Longganisa de Guinobatan is a Filipino pork sausage originating from the town of Guinobatan in Albay, Philippines. It is a type of de recado longganisa with different varieties', 'LGNSA', 1, 1, 50, 'A', 'long-5.jpg', 1, 0, '2021-04-11', '0'),
(2, 'Pilinuts', ' pili nut is a rich, buttery nut. Its taste is unique, often described as a cross between a macadamia nut and a cashew nut, but with a stronger, more tender flavor.', 'PNT', 1, 3, 180, 'A', 'l1.jpg', 0, 0, '2021-04-12', '0'),
...
(5, 'Original Lambanog', 'Lambanog or coconut wine or vodka. This local wine is essentially processed tuba and well known for its strength that ordinarily carries regarding 80 to 90 proof alternatives.', 'LBNG', 2, 3, 150, 'A', 'B-lambanog.jpg', 0, 1, '2021-04-11', '0'),
(6, 'Tuba', 'a non-alcoholic version made from fresh coconut sap. Tuba is stored in large bottle gourds mixed with coconut milk, ice, and sugar. It is usually topped with walnuts and diced fruit.', 'TBA', 2, 3, 130, 'A', 'B-tuba.jpg', 1, 0, '2021-04-11', '0'),
...
(9, 'Pilinut Keychain', 'Bicol Keychains made by ceramics and the raw pili,oftenly used as a signature souvenir from Bicol.', 'PKCH', 4, 5, 20, 'A', 'A-a3.jpg', 1, 0, '2021-04-11', '0'),
...
(12, 'Camalig Special Pinangat', 'Pinangat is a famous native chili-hot delicacy of the town of Camalig. A vegetable dish cooked in coconut milk mixed with select spices and gabi.', 'CPINGT', 1, 6, 100, 'A', 'F-pinangat.jpg', 0, 0, '2021-04-01', '0'),
...
(14, 'Special Bicol Express', 'Pork Bicol Express is a type of Filipino spicy pork dish. Its main source of flavor is derived from shrimp paste, which is locally known as bagoong.', 'BCX', 1, 7, 300, 'A', 'F-bicol express.jpg', 0, 0, '2021-04-11', '0'),
...
(18, 'Money Keeper', 'Ceramic material, cute pig for fecoration. Banks pig, that will attract and encourage your little one to start saving money and develop a good habit.', 'MNYK', 3, 9, 100, 'A', 'C-alkansya.jpg', 0, 1, '2021-04-11', '0'),
...
(21, 'Tilmok', 'Tilmok is a staple food in the Philippines\' Bicol region due to abundance of crab and coconut. It is steamed crab meat with coconut.', 'TMK', 1, 1, 50, 'A', 'F-tilmok.png', 0, 1, '2021-04-11', '0'),
...
(26, 'Pili Brownies', 'Rich, chewy, double chocolate brownies made with the amazing Pili nuts (or macadamia nuts)!A must try Bicol delicacy.', 'PLBWN', 1, 4, 200, 'A', 'F-pili-brownies.jpg', 0, 0, '2021-04-11', '0'),
...
(39, 'Sili with Leaves Keychain ', 'Bicol Keychains made by ceramics and the raw pili,oftenly used as a signature souvenir from Bicol.', 'SLKCH', 4, 5, 20, 'A', 'l8.jpg', 0, 0, '2021-04-11', '0'),
(40, 'Oragon Unisex Jacket', 'High-quality Bicol Oragon Jacket designed and sold by independent local artists around Albay.', 'ORNUNS', 5, 10, 200, 'A', 'S-jacket.png', 0, 0, '2021-04-11', '0'),
...
(43, 'Bicol Express Shirt', 'High-quality Bicol unisex express shirts t-shirts designed and sold by independent local artists around Albay.', 'XPRSSRT', 5, 10, 100, 'A', 'S-bicol-express.jpg', 0, 0, '2021-04-12', '0'),
...
(74, '295466093b6eb0de02', 12, 4, 720, '2021-05-06', 'C'),
(75, '460016093b71190afd', 12, 7, 1750, '2021-05-06', 'C'),
(76, '156656093b7d24f1d8', 12, 18, 1740, '2021-05-06', 'C');
