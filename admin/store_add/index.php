...
<div class="container">
	<h1 class="page-header text-center">Store Location</h1>
	<div class="row">
						...
						<?php
							...
							while($row = $query->fetch_assoc()){
								...
								"<tr>
									...
									<td>
										<a href='#edit_".$row['add_id']."' class='btn btn-success btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-edit'></span>Update</a>
