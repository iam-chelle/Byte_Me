		...
		<body>
			...
			<div class="container">
				...
				<div class="small-container single-product">
					<div class="row">
					<div class="col-2">
						<img src="img/B-tuba.jpg" alt="" width="100%" id="ProductImg">
				...
				<div class="small-container">
					<div class="row row-2">
						<h2>Related Alcoholic Beverages</h2>
				...
				<div class="row">
					<div class="col-4">
						...
						<div class="col-4">
						<img src="img/B-rice.jpg" alt="" width="200px" height="200px">
						<h4>Rice Wine</h4>
						<div class="rating">
							<i class="fa fa-star" aria-hidden="true"></i>
							<i class="fa fa-star" aria-hidden="true"></i>
						...
						<div class="col-4">
						<img src="img/B-basi.jpg" alt="" width="200px" height="200px">
						<h4>Basi Wine</h4>
						<div class="rating">
							<i class="fa fa-star" aria-hidden="true"></i>
							<i class="fa fa-star" aria-hidden="true"></i>
						...
						<div class="col-4">
						<img src="img/Sale-nipa.jpg" alt="" width="200px" height="200px">
						<h4>Nipa Wine</h4>
						<div class="rating">
							<i class="fa fa-star" aria-hidden="true"></i>
							<i class="fa fa-star" aria-hidden="true"></i>
